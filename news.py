...
# WELCOME_MESSAGE = 'Good Morning! And welcome to your morning minutes. Here are the top headlines for Tuesday, February 4th'
...
def main():
       ...
       extract = extract_minits(payload, True)
       urls = extract[0]
       headlines = extract[1]
       imageUrls = extract[2]
